function [simOut] = spatialIIR_symbolicTheroy(cfgIn,scriptFlags)
%% path handling
...
if scriptFlags.crlbSimpleSim
    ...
    simOut.crlbSimpleSim_output = crlbSimpleSim_output;
end
if scriptFlags.beamwidthCalc
    ...
    simOut.beamwidthCalc_output = beamwidthCalc_output;
end
if scriptFlags.tauErrorEffect
    ...
    simOut.tauErrorEffect_output    = tauErrorEffect_output;
end
end