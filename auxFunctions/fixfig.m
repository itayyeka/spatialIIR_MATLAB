...
% MH Aug2020
% v2.2   handle some edge cases:
%			plot has errorbars (thanks to Jean-Baptiste Thomazo)
%			figure has no axes (thanks to Felipe G. Nievinski)
...
if verLessThan('matlab','R2014b')
	...
	if isempty(ax), ax = axes(); end	% handle the case where figure has no axes 
