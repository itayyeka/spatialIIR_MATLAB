...
try
    ...
    simCfg              = [];
    simCfg.nSensors     = 3;
    simCfg.nIterations  = 300;
    simCfg.inputFreq    = 10e9;
    simCfg.dF_ratio     = 1e-3;
    simCfg.r            = 0.6;
end
...
if true
    ...
    if true
        simCfg                      = simCfg_base;
        simCfg.compensationFreq     = 1*simCfg_base.inputFreq*simCfg.dF_ratio;
    ...
    if true
        simCfg                          = simCfg_base;
        simCfg.overrideFeedbackCoeffs   = [zeros(1,N-1) 1/simCfg.r];
